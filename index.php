  ...
  <body class="size-1140">
      ...
      <nav class="background-transparent background-transparent-hightlight full-width sticky">
        ...
        <div class="top-nav s-12 l-10">
          ...
          <ul class="right chevron">
              ...
              <li><a>Animácie dynamického systému</a>
                  <ul>
                      <li><a href="kyvadlo.html">Inverzné kyvadlo</a></li>
                      <li><a href="gulicka.html">Gulička na tyči</a></li>
                      <li><a href="tlmice.html">Tlmič automobil</a></li>
                      <li><a href="lietadlo.html">Náklon lietadla</a></li>
                  </ul>
              <li><a href="technic_document.html">Technická dokumentácia</a></li>
          </ul>
        </div>
      </nav>
    </header>
    ...
    <main role="main">    
              ...
              <div class="carousel-content">
                <div class="content-center-vertical line">
                  <div class="margin-top-bottom-80">
                    <!-- Title -->
                    <h1 class="text-white margin-bottom-30 text-size-60 text-m-size-30 text-line-height-1">Simple<br>MATH</h1>
                    <div class="s-12 m-10 l-8 center"><p class="text-white text-size-14 margin-bottom-40">slúži nie len ako pomoc pri numerických riešeniach problémov lineárnej algebry, ale aj ako geometrické a matematické zobrazenie pomocou simulácie a modelovania dynamických systémov.</p></div>
                    <div class="line">
      ...
      <section class="section">
        <div class="line">
          <h2 class="text-size-50 text-center">O nás</h2>/ prvá alternatíva /
          <hr class="break-small background-primary break-center">
        </div>
        <div class="line">
          <div class="margin">  
            <div class="s-12 m-12 l-2" style="float: left; margin-left: 5%">
              <p class="h1 text-size-30 margin-m-bottom-30 text-primary text-line-height-1 text-right"><br><br><br>Sme<br>odhodlaní tvoriť nové veci</p>
            </div>
...
-->
              ...
              <!--<div class="line">
                ...
                <div style="float: left; margin-left: 10%; width: 50%"  class="carousel-default owl-carousel carousel-wide-arrows">
                  <div class="item">
...
-->
      ...
      <!-- Section 2 -->
        <section class="section background-white" >
            <div class="line">
                <h2 class="text-size-50 text-center">O nás</h2>/ asi lepšia alternatíva :D /
                <hr class="break-small background-primary break-center">
                <div class="margin margin-top-bottom-50">
                    <div class="s-12 m-12 l-3">
                        <div class="block">
                            <div class="count-to">
                                <img src="img/man.jpg"/>
                                <p class="h1 text-size-20 margin-top-10 text-dark text-thin">Slavomír Martavuz</p>
                            </div>
                        </div>
                    </div>
                    <div class="s-12 m-12 l-3">
                        <div class="block">
                            <div class="count-to">
                                <img src="img/man.jpg"/>
                                <p class="h1 text-size-20 margin-top-10 text-dark text-thin">Adam Novák</p>
                            </div>
                        </div>
                    </div>
                    <div class="s-12 m-12 l-3">
                        <div class="block">
                            <div class="count-to">
                                <img src="img/man.jpg"/>
                                <p class="h1 text-size-20 margin-top-10 text-dark text-thin">Mário Lukáč</p>
                            </div>
                        </div>
                    </div>
                    <div class="s-12 m-12 l-3">
                        <div class="block">
                            <div class="count-to">
                                ...
                                <p class="h1 text-size-20 margin-top-10 text-dark text-thin" style="text-align: center">Jana Pochybová</p>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <section class="section background-white" >  
        <div class="line">
          <h2 class="text-size-50 text-center">Štatistiky</h2>
          <hr class="break-small background-primary break-center">
          <div class="margin margin-top-bottom-50">
            <div class="s-12 m-12 l-3">
              <div class="block">
            ...
            <div class="line">              
              <div class="float-left">
                ...
                <div class="margin-left-70 margin-bottom-30">
                  ...
                  <p>Ilkovičova 2961, 841 04 Karlova Ves<br>
                      Fakulta elektrotechniky a informatiky<br>
                      Apllikovaná informatika<br>
                ...
                <div class="margin-left-70 margin-bottom-30">
                  ...
                  <p>xmartavuz@stuba.sk<br>
                      xlukacm@stuba.sk<br>
                      xnovaka1@stuba.sk<br>
                      xpochybovaj@stuba.sk
                  </p>              
                </div>
               </div>
          </div>
